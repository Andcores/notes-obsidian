**Security frameworks**: are guidelines used to building plans to help mitigate risk and threats to data and privacy, the have four components:
...
**Compliance**: is the process of adhering internal standards and external regulations.


**Specific controls, Frameworks, and compliance**
(NIST) The National institute of Standard Technology is a US based agency that develops multiple voluntary compliance frameworks that organizations worldwide can use to help manage risk.
the more aligned an organizations is with compliance , the lower risk.

Examples of frameworks include NIST Cybersecurity framework (CSF) And the NIST Risk management framework (RMF)

In addition to the NIST CSF and NIST RMF there are several other controls, frameworks and compliance standards that are important to security professionals to be familiar with to help keep organizations and the people they serve safe.



Other frameworks to cybersecurity 
...
[[Cybersecurity/1 Foundations of cybersecurity/Frameworks and control/Framework]]
